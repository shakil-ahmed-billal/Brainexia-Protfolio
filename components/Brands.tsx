...
export default function Brands() {
  const logos = [
    { src: "/brands/brand-1.png", alt: "Brand 1" },
    { src: "/brands/brand-2.png", alt: "Brand 2" },
    { src: "/brands/brand-3.png", alt: "Brand 3" },
    { src: "/brands/brand-4.png", alt: "Brand 4" },
  ];

  const allLogos = [...logos, ...logos, ...logos, ...logos];

  return (
    <section className="bg-white overflow-hidden py-1 border-b border-gray-200 lg:border-b-0">
