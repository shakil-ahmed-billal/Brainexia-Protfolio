...
const testimonials = [
  {
    ...
    image: "/testimonials/testimonial-man-1.png",
    content:
  ...
  },
  {
    ...
    image: "/testimonials/testimonial-girl-2.png",
    content:
  ...
  },
  {
    ...
    image: "/testimonials/testimonial-girl-1.png",
    content:
            ...
            return (
              ...
              >
                <div className="relative w-24 h-24 mb-8 shrink-0">
                  <div
                    className={`absolute inset-0 bg-gray-100 rounded-full overflow-hidden border-4 transition-all duration-500 ${isHighlighted ? "border-white shadow-md" : "border-transparent"}`}
                  >
                    <Image
                      src={item.image}
                      alt={item.name}
                ...
                <div className="mt-auto">
                  <h4 className="text-[#0a1d37] font-bold text-[16px] leading-[28px] mb-1 font2">
                    {item.name}
                  </h4>
