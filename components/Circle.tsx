...
const Circle: React.FC = () => {
  const activities = [
    {
      ...
      date: "Aug 10",
      icon: "✎",
      posClass: "lg:top-[15%] lg:right-[10%]",
    },
    {
      id: 2,
      name: "Andrea",
      ...
      date: "June 05",
      icon: "✎",
      posClass: "lg:bottom-[20%] lg:right-[15%]",
    },
    {
      id: 3,
      name: "Karen",
      ...
      date: "July 25",
      icon: "💬",
      posClass: "lg:bottom-[25%] lg:left-[10%]",
    },
  ];
  ...
  const users = [
    {
      id: 4,
      img: "/users/user-man-1.png",
      posClass: "lg:top-[10%] lg:left-[20%]",
    },
    {
      id: 5,
      img: "/users/user-man-2.png",
      posClass: "lg:bottom-[5%] lg:left-[35%]",
    },
    {
      id: 6,
      img: "/users/user-man-3.png",
      posClass: "lg:top-[30%] lg:right-[15%]",
    },
  ];
        ...
        <div className="relative flex flex-col items-center lg:block h-auto lg:h-[750px]">
          <div className="relative z-20 flex justify-center items-center mb-16 lg:mb-0 lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2">
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 flex items-center justify-center bg-white rounded-full shadow-2xl border border-gray-50 overflow-hidden">
              ...
              <div className="text-center z-10 bg-white rounded-full p-4">
                <h2 className="text-4xl md:text-[46px] font-black text-[#3B32F3] font2 tracking-tighter">
                  5M+
                </h2>
                <p className="text-gray-400 font-medium text-xs md:text-[17px] font1">
                  Active Members
                </p>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col gap-4 md:grid md:grid-cols-2 lg:block">
            {activities.map((item) => (
              <div
                key={item.id}
                className={`lg:absolute z-30 bg-white p-4 rounded-2xl shadow-lg flex items-start space-x-3 border border-gray-50 transition-all hover:scale-105 hover:z-50 max-w-[280px] mx-auto lg:mx-0 ${item.posClass}`}
              >
                ...
                <div>
                  ...
                  <span className="text-[10px] text-gray-400 mt-1 block font-semibold uppercase">
                    {item.date}
                  </span>
                </div>
              </div>
          ...
          <div className="hidden lg:block">
            {users.map((user) => (
              <div
                key={user.id}
                className={`absolute z-10 w-28 h-28 rounded-full overflow-hidden border-4 border-white shadow-xl ${user.posClass}`}
              >
                <Image
                  key={user.id}
                  src={user.img}
