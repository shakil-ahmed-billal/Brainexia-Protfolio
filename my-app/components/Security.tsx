                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-10">
                        ...
                        <div className="w-full lg:basis-[50%] mt-10 lg:mt-50 text-center lg:text-left">
                            ...
                            <p className="text-[#12141D] mt-6 max-w-md mx-auto lg:mx-0">
                                ...
                                <span className="lg:block">nostrama inceptos himenaeos. Donec tristique nibh ipsum </span> dignissim.
                            </p>
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h4 className="h-color text-[21px] font-bold font2">Well Organised User Interface</h4>
                                    <p className="p-color mt-2 text-[18px]">Etiam id euismod odio. Ut euismod sem a lacus fringilla.</p>
                                </div>
                                <div>
                                    <h4 className="h-color text-[21px] font-bold font2 mt-6 lg:mt-10">Completely Bug Free</h4>
                                    <p className="p-color mt-2 text-[18px]">Cras eleifend leo ac varius tristique suspendisse.</p>
                                </div>
                            </div>
                        </div>
