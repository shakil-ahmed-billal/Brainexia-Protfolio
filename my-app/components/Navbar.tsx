...
export default function Navbar() {
    ...
    return (
        <nav className="bg-white sticky top-0 z-[100] border-b border-gray-100">
            ...
            <div className={`lg:hidden absolute top-full left-0 w-full bg-white border-b border-gray-100 transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-[500px] py-6 opacity-100' : 'max-h-0 opacity-0'}`}>
