        ...
        <section className="py-16 md:py-20 bg-white">
            <div className="container-custom text-center">
                ...
                <div className="max-w-2xl mx-auto mb-10 md:mb-16 space-y-4 px-4">
                    ...
                    <p className="text-[#141F39] text-base md:text-[16px] leading-relaxed font1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 px-6 md:px-0">
                    {featureData.map((item, index) => (
                        ...
                        >
                            <div className="mb-6 md:mb-8 flex justify-center">
                                <div className="relative w-16 h-16 md:w-20 md:h-20 transition-transform duration-500 group-hover:rotate-[180deg]">
                                    <Image
                                        src={item.icon}
                                        alt={item.title}
                                        fill
                            ...
                            <h3 className="text-xl md:text-[21px] font-bold h-color font2 mb-3 md:mb-4">
                                {item.title}
                            </h3>
                            <p className="p-color font1 leading-relaxed text-base md:text-[18px]">
                                {item.desc}
                            </p>
                        </div>
                    ))}
                ...
                <p className='text-center p-color mt-10 md:mt-15 text-lg md:text-[20px] px-4'>
                    Approx <span className='text-[#7564F8] font-bold'>875+</span> team members ready to online support for you
                </p>
            </div>
        </section>
    );
